...
Выбери время начала и окончания:`,
  ...
  SETTINGS_TIMEZONE_SELECT: `🌍 <b>Выбери часовой пояс</b>

Все настройки времени будут работать по выбранному часовому поясу.`,
...
Попробуй завтра или добавляй слова по одному через /add.`,
  ...
  BUTTON_TUTOR_CHAT: 'Чат с учителем',
  BUTTON_STOP_TUTOR_CHAT: 'Завершить чат с учителем',
  BUTTON_BACK: '« Назад',
  BUTTON_CLOSE: '✕ Закрыть',

  // Tutor Chat
  TUTOR_CHAT_STARTED: `Привет! Я твой учитель грузинского языка.

Присылай мне слова на грузинском или русском — я переведу и покажу пример использования.

Можешь также задавать вопросы о грамматике и правилах.

Пока чат активен, уведомления и квизы приостановлены.`,

  TUTOR_CHAT_ENDED: 'Чат с учителем завершён. Возвращаемся к обучению!',

  TUTOR_CHAT_ALREADY_ACTIVE: 'Чат с учителем уже активен. Просто пиши сообщения!',

  TUTOR_CHAT_QUIZ_BLOCKED: 'Сейчас активен чат с учителем. Заверши чат, чтобы начать квиз.',
} as const
